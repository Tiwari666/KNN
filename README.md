...
The prediction in the KNN is made based on the MODE. For example, there are 30 emplyees in a company. Suppose there are
...
Step 2: Find the K (4) nearest data point for our new data point based on euclidean distance
